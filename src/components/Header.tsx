      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3.5 flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 min-w-0">
        <div className="flex items-center gap-2 sm:gap-3.5 min-w-0 flex-1">
          ...
          <div className="min-w-[260px] flex-1">
            <h1 className="text-sm sm:text-base lg:text-lg font-black tracking-tight text-slate-900 dark:text-white leading-tight uppercase whitespace-normal">
              MNS University of Engineering &amp; Technology, Multan
            </h1>
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mt-1 min-w-0">
              <span className="text-[10px] sm:text-[11px] font-extrabold text-emerald-700 dark:text-emerald-400 tracking-wide uppercase shrink-0 bg-emerald-100/60 dark:bg-emerald-950/60 px-2 py-0.5 rounded-md border border-emerald-300 dark:border-emerald-800">
                CENTRAL MONITORING PORTAL
              </span>
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] font-bold bg-emerald-50 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/60 shrink-0">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                Task: {activeModule === 'LMS' ? 'LMS Result Upload Status' : 'Work on Demand Logs'}
              </span>
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 shrink-0">
