...
export const UNIVERSITY_DEPARTMENTS: DepartmentGroup[] = [
  {
    ...
    programs: [
      ...
      { name: 'B.Sc. Software Engineering Technology (B.Tech)', degreeLevel: 'B.Tech', department: 'Department of Computer Science', session2023: false, supportedShifts: ['Evening'] },
      ...
      { name: 'PhD Computer Science', degreeLevel: 'PhD', department: 'Department of Computer Science', session2023: false, supportedShifts: ['Morning', 'Evening'] },
    ],
  },
  {
    ...
    programs: [
      ...
      { name: 'MS Electrical Engineering', degreeLevel: 'MS', department: 'Department of Electrical Engineering & Technology', session2023: false, supportedShifts: ['Morning', 'Evening'] },
      { name: 'PhD Electrical Engineering', degreeLevel: 'PhD', department: 'Department of Electrical Engineering & Technology', session2023: false, supportedShifts: ['Morning', 'Evening'] },
    ],
  },
  {
    ...
    code: 'ME',
    programs: [
      { name: 'B.Sc. Mechanical Engineering', degreeLevel: 'BS Engineering', department: 'Department of Mechanical Engineering & Technology', session2023: false, supportedShifts: ['Morning', 'Evening'] },
      ...
      { name: 'MS Mechanical Engineering', degreeLevel: 'MS', department: 'Department of Mechanical Engineering & Technology', session2023: false, supportedShifts: ['Morning', 'Evening'] },
    ],
  },
  {
    ...
    programs: [
      ...
      { name: 'MS Civil Engineering', degreeLevel: 'MS', department: 'Department of Civil Engineering & Technology', session2023: false, supportedShifts: ['Morning', 'Evening'] },
    ],
  },
  {
  ...
  },
  {
    ...
    programs: [
      ...
      { name: 'MBA', degreeLevel: 'MBA', department: 'Department of Management Sciences', session2023: false, supportedShifts: ['Morning', 'Evening'] },
      { name: 'MS Management Sciences', degreeLevel: 'MS', department: 'Department of Management Sciences', session2023: false, supportedShifts: ['Morning', 'Evening'] },
      { name: 'MS Project Management', degreeLevel: 'MS', department: 'Department of Management Sciences', session2023: false, supportedShifts: ['Morning', 'Evening'] },
    ],
  },
  {
    ...
    programs: [
      ...
      { name: 'MS Physics', degreeLevel: 'MS', department: 'Department of Basic Sciences & Humanities', session2023: false, supportedShifts: ['Morning', 'Evening'] },
    ],
  },
];
